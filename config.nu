...
$env.config = {
    ...
    #     }
    #     {
    #         name: move_one_word_right_or_take_history_hint_right
    #         modifier: control
    #         keycode: right
    #         mode: [emacs, vi_normal, vi_insert]
    #         event: {
    ...
    #     }
    #     {
    #         name: delete_one_character_backward_escape_backspace
    #         modifier: none
    #         keycode: backspace
    ...
    #     }
    #     {
    #         name: delete_one_word_backward_space
    #         modifier: control
    #         keycode: backspace
    #         mode: [emacs, vi_insert]
    ...
    #     }
    #     {
    #         name: delete_one_character_forward_ctrldelete
    #         modifier: control
    #         keycode: delete
    #         mode: [emacs, vi_insert]
    #         event: { edit: delete }
    #     }
    #     {
    #         name: delete_one_character_backward_ctrlh
    #         modifier: control
    #         keycode: char_h
    #         mode: [emacs, vi_insert]
    #         event: { edit: backspace }
    ...
    #     }
    #     {
    #         name: move_right_or_take_history_hint_cf
    #         modifier: control
    #         keycode: char_f
    #         mode: emacs
    #         event: {
    ...
    #     }
    #     {
    #         name: move_one_word_right_or_take_history_hint_rig
    #         modifier: alt
    #         keycode: right
    #         mode: emacs
    #         event: {
    ...
    #     }
    #     {
    #         name: move_one_word_right_or_take_history_hint_f
    #         modifier: alt
    #         keycode: char_f
    #         mode: emacs
    #         event: {
